...
1. If you have compiled yourself (see above), copy `cql-module/target/cql-module-1.1-SNAPSHOT-exist.jar` to `$EXIST_HOME/lib/user`, or download `cql-module-1.0-exist.jar` from Maven Central to `$EXIST_HOME/lib/user`
